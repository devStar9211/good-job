...
Configure::load('config', 'ini', true);

Configure::load('_config');
CakePlugin::load('AclExtras');
CakePlugin::load('AclManager', array('bootstrap' => true, 'admin' => true));
 ...
 */
Configure::write('AclManager.aros', array('GroupPermission'));
