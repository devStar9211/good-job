<?php
	...
	echo $this->element('csv_modal_import', array(
		...
		'action' => 'admin_import_point_bonus_from_csv',
		'multiple' => true
	));
	$this->end();
?>
		...
		<div class="box-body">
			...
			<div class="row row-5">
				<div class="col-sm-6 group-btn mt10">
					<div>
						<?php
							echo $this->Html->link('<i class="fa fa-file-text-o fa-2x" aria-hidden="true"></i>&nbsp;'. __('download sample csv file for import bonus base'), array('controller' => 'PointBonus', 'action' => 'admin_export_sample', 'point_bonus'), array('escape' => false));
						?>
					</div>
					<div class="mt10">
						<?php
