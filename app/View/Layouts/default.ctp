...
<script type="text/javascript">
    $(document).ready(function(){
        var email = "<?php echo !empty($require_email['require']) && $require_email['require'] == 1 ? 1 : '0'; ?>";
        if(email == 1){
            $('#myModal').modal({
                backdrop: 'static',
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
    <div class="modal-dialog modal-sm popup-require-email" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <h4 class="modal-title text-center" id="myModalLabel"><?php echo $require_email['mess'] ?></h4>
                <div class="text-center" id="email-link">
                    <!-- <a href="">登録する</a> -->
                    <?php
                    echo $this->Html->link(
                        $require_email['btn_submit'],
                        '/edit_email',
                        array()
                    );
                    ?>
