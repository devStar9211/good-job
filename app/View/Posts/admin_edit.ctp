...
<div class="box">
	...
	<div class="box-body">
		...
		<?php echo $this->Form->create('Post', array('id'=> 'post-validate', 'enctype'=>"multipart/form-data", 'inputDefaults' => array('label' => false, 'div'=>false))); ?>
				<!-- <form action="/admin/posts/add" class="form-horizontal" role="form" enctype="multipart/form-data" id="PostAdminAddForm" method="post" accept-charset="utf-8"> -->
			<div class="col-md-9">
			...
			<div class="col-md-3 post-sidebar">
				...
				<?php echo $this->element('category', array('ct_checks' => $this->request->data['Category'])); ?>
				<div class="box box-info">
					<div class="box-header with-border">
					...
					<div class="box-body">
					<?php if (!empty($this->request->data['Post']['avatar'])): ?>
						<input type="hidden" class="form-control" name="data[Post][avatar]" id="file_avatar" value="<?=$this->request->data['Post']['avatar']?>">
						<div id="avatar"><img src="<?=$this->request->data['Post']['avatar']?>" alt="..." class="img-thumbnail img-check"></div>
						<div id="get-media" style="display: none"><?php echo $this->element('mediaGet'); ?></div>
						<div id="remove-image" ><a href="javascript:void(0)">アイキャッチ画像を削除</a></div>
					<?php else: ?>
						<input type="hidden" class="form-control" name="data[Post][avatar]" id="file_avatar" value="">
						<div id="avatar"></div>
						<div id="get-media" style=""><?php echo $this->element('mediaGet'); ?></div>
