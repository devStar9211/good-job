<?php $this->start('css')?>
  ...
  <?php echo $this->Html->css('/assets/components/multiupload/css/upload'); ?>
<?php $this->end()?>
<div id="media">
  <!-- Button trigger modal -->
  <div class="btn btn-default btn-sm" data-toggle="modal" data-target="#mediaModal">
     メディアを追加
  </div>
      ...
      <div class="modal-content" style="height: 91%">
        ...
        <div class="modal-body">
          <ul class="nav nav-tabs">
            <li id="upload-media"><a data-toggle="tab" href="#upload-files">ファイルをアップロード</a></li>
            <li id="media-list" class="active"><a data-toggle="tab" href="#media-library">メディアライブラリ</a></li>
          </ul>
          <div class="tab-content">
            <div id="upload-files" class="tab-pane fade upload-files">
              <div id="upload" class="btn btn-default btn-sm"><span>ファイルを選択<span></div>
              <span id="status" ></span>
            </div>
            <div id="media-library" class="tab-pane fade in active">
              <div class="">
                <div class="">
                  <div id="filter-media">
                    <div class="col-sm-4">
                      <div class="form-group">
                        <select name="" id="filter_date" class="form-control" required="required">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        <input type="text" class="form-control" id="key-search-file" placeholder="検索">
                      </div>
                    </div> 
                  </div>
        ...
        <div class="modal-footer">
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <button type="button" id="delete-media" class="btn btn-primary pull-left" disabled='disabled' >削除</button>

                <button type="button" id="insert-into-post" data-dismiss="modal" class="btn btn-primary" disabled='disabled' >投稿に挿入</button>
              </div>
            </div>
          </div>
        </div>
...
<?php $this->start('script')?>
  ...
  <?php echo $this->Html->script('/assets/components/multiupload/js/fileuploadmulti'); ?>
