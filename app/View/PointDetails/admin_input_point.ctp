...
<div class="box box-default">
    <div class="box-header with-border">
        ...
        <div class="pull-right box-tools">
            <div class="btn-group">
                <?php
                echo $this->Html->link(__('CSVアップロード'), array('controller' => 'point_details', 'action' => 'admin_csv_import'), array('class' => 'btn btn-primary'));
                echo $this->Html->link(__('CSVダウンロード'), array('controller' => 'point_details', 'action' => 'export'), array('class' => 'btn btn-primary'));
                ?>
            </div>
        </div>
    </div>
    <div class="box-body">
        <?php
        echo $this->Form->create('CampaignPoint', array(
            'url' => array(
            ...
            'autocomplete' => 'off',
            'data-source' => $this->Html->url(array('controller' => 'point_details', 'action' => 'admin_ajax_manual_input'))
        ));
        ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class='input-group date'>
                        <?php echo $this->Form->input('date', array('type' => 'text', 'value' => (isset($data['date']) ? $data['date'] : ''), 'class' => 'form-control', 'id' => 'dateSelectManualInputPoint', 'placeholder' => __('年度'), 'role' => 'date', 'onchange' => 'points_filter_employee(this)')) ?>
                        <label for="dateSelectManualInputPoint" class="input-group-addon">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    echo $this->Form->select('point_type', $data['point_types'], array('empty' => __(''), 'default' => (isset($data['point_type']) ? $data['point_type'] : ''), 'class' => 'form-control select2', 'id' => 'office_id', 'role' => 'point_type', 'onchange' => 'points_filter_employee(this)')) ?>
                </div>
            </div>
        </div>
        ...
        <div class="table-wrap dataTables_wrapper form-inline dt-bootstrap">
            ...
            <div class="mh55" id="budget_revenue_tb" role="tb">
                <?php echo $this->element('manual_input_point_table', array('data' => $data)) ?>
            </div>
        </div>
