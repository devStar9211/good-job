        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2  col-sm-2 col-xs-2">
                            <div class="input-group colorpicker1">
                                <?php
                                echo $this->Form->input('FormData.' . $config_field['fields']['color'] . '.' .
                                    $_data[$config_field['model']]['id'], array('type' => 'text', 'label' => false, 'style' => 'width: 100%; ', 'value' => $_data[$config_field['model']]['color'], 'class' => 'form-control ', 'maxlength' => '100', 'placeholder' => __('Graph color'), 'div' => ''));
                                ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                        <?php
                        echo $this->Form->input('EditData.color', array('label' => false, 'style' => 'width: 100%; ', 'value' => '', 'class' => 'form-control', 'placeholder' => __('Graph color')));
                        ?>
                    </div>
                    <div class="col-md-6  col-sm-6 col-xs-6">
                        <div class="row" style="width: 250px;">
