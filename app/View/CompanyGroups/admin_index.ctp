        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <?php foreach ($collection as $_data) { ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="cat_col_name col-md-4  col-sm-4 col-xs-4">
                            ...
                            echo $this->Form->input('FormData.group_permission_id.' . $_data[$config_field['model']]['id'], array('type' => 'hidden', 'label' => false, 'style' => 'width: 100%; ', 'value' => $_data[$config_field['model']]['group_permission_id'], 'class' => 'form-control ', 'maxlength' => '100'));
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            <?php
                            echo $this->Form->input('FormData.' . $config_field['fields']['start_month'] . '.' .
                                $_data[$config_field['model']]['id'], array('type' => 'select', 'label' => false, 'style' => 'width: 100%; ', 'options' => $start_months, 'default' => $_data[$config_field['model']]['start_month'], 'class' => 'form-control ', 'maxlength' => '100'));
                            ?>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <?php
                        echo $this->Form->input('EditData.start_month', array('type' => 'select', 'label' => false, 'style' => 'width: 100%; ', 'options' => $start_months, 'class' => 'form-control', 'placeholder' => __('Price')));
                        ?>
                    </div>
                    <div class="col-md-6">
                        <div class="row" style="width: 250px;">
