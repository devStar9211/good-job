<div class="box">
	...
	<div class="box-body">
		...
		<?php
			echo $this->Form->input('company_group_id',array('options' => $companyGroups, 'empty' => true, 'default' => $this->request->data['Company']['company_group_id'], 'label' => array('text' => __('group company'),'class'=>'control-label col-xs-12 col-sm-2')));
