                        ...
                        <div class="col-md-2  col-sm-2 col-xs-2">
                            <div class="input-group colorpicker1">
                                ...
                                echo $this->Form->input('FormData.' . $config_field['fields']['color'] . '.' .
                                    $_data[$config_field['model']]['id'], array('type' => 'text', 'label' => false, 'style' => 'width: 100%; ', 'value' => $_data[$config_field['model']]['color'], 'class' => 'form-control ', 'maxlength' => '100', 'placeholder' => __('Color'), 'div'=>''));
                                ?>
