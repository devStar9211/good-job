        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            ...
                            echo $this->Form->input('FormData.' . $config_field['fields']['price'] . '.' .
                                $_data[$config_field['model']]['id'], array('type' => 'text', 'label' => false, 'style' => 'width: 100%; ', 'value' => $_data[$config_field['model']]['price'], 'class' => 'form-control ', 'maxlength' => '100', 'required'=> true, 'placeholder' => __('Price')));
                            ?>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <?php
                        echo $this->Form->input('EditData.price', array('label' => false, 'style' => 'width: 100%; ', 'value' => '', 'class' => 'form-control', 'placeholder' => __('Price'), 'required'=> true));
                        ?>
                    </div>
                    <div class="col-md-6">
                        <div class="row" style="width: 250px;">
