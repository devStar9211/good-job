...
?>
    <script type="text/javascript">
        ...
        $("#EmployeeEmployeeNumber").blur(function () {
            check_duplicate_employee_number(this);
        });

        function check_duplicate_employee_number(node) {
            var self = node,
                $field_target = $($(self).data('field-node')),
                source = $(self).data('source'),
                employee_number = $(self).val();
            if (employee_number !== '' && source != undefined) {
                $.ajax({
                    url: source,
                    type: 'POST',
                    dataType: 'json',
                    ...
                    .done(function (res, status, xhr) {
                        ...
                        if (res.status) {
                            console.log(res);
//                            $(self).closest('.input.text').addClass('has-error');


                            var is_duplicate = res.is_duplicate;
                            if (is_duplicate == 1) {
                                $(self).closest('.input.text').find('.control-label').remove();
                                console.log($field_target);
                                $(self).closest('.input.text').addClass('has-error');
                                $(self).closest('.input.text').append('<label class="control-label" before="<i class=&quot;fa fa-times-circle-o&quot;></i> "><i class="fa fa-times-circle-o"></i> 社員番号が重複しています</label>');

                                return false;

                            } else {
                                $(self).closest('.input.text').find('.control-label').remove();
                                $(self).closest('.input.text').removeClass('has-error');
                            }
                ...
                $.ajax({
                    ...
                    .done(function (res, status, xhr) {
                        ...
                        if (res.status) {
                            ...
                            check_duplicate_employee_number($field_target);
                        }
                    });
            } else {
                $field_target.val();
                        ...
                        <div class="row no-margin">
                            <div class="col-sm-6 no-padding">
								...
								<span class="input-group-addon avatar-wrap text-center">
                                    ...
                                    <?php
                                    echo $this->Form->input('Employee.avatar.input', array('type' => 'hidden', 'hidden' => 'hidden', 'id' => 'avatar-input'));
                                    echo $this->Form->input('Employee.avatar.original', array('type' => 'hidden', 'hidden' => 'hidden', 'id' => 'avatar-input-original'));
                                    echo $this->Form->input('Employee.avatar.points', array('type' => 'hidden', 'hidden' => 'hidden', 'id' => 'avatar-points'));
                                    ?>
								</span>
                                    <div class="control-wrap">
                                        <div class="form-group">
                                            <?php echo $this->Form->input('name', array('type' => 'text', 'class' => 'form-control', 'placeholder' => __('name'), 'role' => 'name')) ?>
                                        </div>
                                        <div class="form-group w100">
                                            <div class='input-group date' id='dob'>
                                                <?php echo $this->Form->input('dob', array('div' => false, 'type' => 'text', 'value' => '', 'class' => 'form-control yearMonthDaySelect', 'placeholder' => __('birthday'), 'role' => 'dob', 'value' => (!empty($data['dob']) ? $data['dob'] : ''))) ?>
                                        ...
                                        <div class="form-group">
                                            <div class="register-switch">
                                                <input type="radio" name="data[Employee][gender]" value="0" id="sex_m"
                                                       class="register-switch-input" <?php echo isset($data['gender']) && $data['gender'] != 0 ? '' : 'checked' ?>>
                                                <label for="sex_m"
                                                       class="register-switch-label"><?php echo __('male') ?></label>
                                                <input type="radio" name="data[Employee][gender]" value="1" id="sex_f"
                                                       class="register-switch-input" <?php echo isset($data['gender']) && $data['gender'] == 1 ? 'checked' : '' ?>>
                                                <label for="sex_f"
                            ...
                            <div class="col-sm-6 padding-left-sm">
                                <div class="form-group">
                                    <?php echo $this->Form->input('kana_name', array('type' => 'text', 'class' => 'form-control', 'role' => 'name', 'placeholder' => __('tên furigana'))) ?>
                                </div>
                                <div class="form-group">
                                    <?php echo $this->Form->input('Account.email', array('type' => 'email', 'class' => 'form-control', 'role' => 'email', 'placeholder' => __('mail adress'))) ?>
                                </div>
                                <div class="form-group">
                                    <?php echo $this->Form->input('phone', array('type' => 'text', 'class' => 'form-control input-phone', 'role' => 'phone', 'placeholder' => __('phone number'))) ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="row no-margin">
                                <div class="col-xs-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('Account.username', array('type' => 'text', 'class' => 'form-control', 'role' => 'username', 'label' => __('username'), 'placeholder' => __('username'), 'autocomplete' => 'off', 'readonly'=>'readonly', 'onfocus'=>"this.removeAttribute('readonly');")) ?>
                                    </div>
                                    <div class="form-group">
                                        <?php echo $this->Form->input('Account.password', array('type' => 'password', 'class' => 'form-control', 'role' => 'password', 'label' => __('password'), 'placeholder' => __('password'))) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="row no-margin">
                                ...
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <label for="EmployeeOfficeId"><?php echo __('hiring pattern') ?></label>
                                        <?php
                            ...
                            <div class="row no-margin">
                                ...
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group required">
                                        <?php echo $this->Form->input('employee_number', array('type' => 'text', 'class' => 'form-control', 'label' => __('employee number'), 'placeholder' => __('employee number'), 'value' => '', 'data-source' => $this->Html->url(array('controller' => 'employees', 'action' => 'admin_ajax_check_duplicate_employee_number')))) ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row no-margin">
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group no-margin">
                                        <label class="align-middle h34 checkbox-wrap">
                                            <?php
                                            echo $this->Form->input('in_office', array('div' => false, 'type' => 'checkbox', 'class' => 'larger'));
                                            echo __('in office');
                                            ?>
                                        </label>
                                    </div>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="row no-margin">
                                ...
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <label for="EmployyOccupations"><?php echo __('occupation') ?></label>
                        ...
                        <div class="box-body">
                            <div class="row no-margin">
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php
                                        echo $this->Form->input('postal_code', array('type' => 'text', 'class' => 'form-control postal-code', 'label' => __('postal code'), 'placeholder' => __('postal code'), 'role' => 'postal_code', 'onkeyup' => 'AjaxZip3.zip2addr(this,"","data[Employee][prefecture]","data[Employee][municipality]","data[Employee][municipal_town]","",false)'));
                                        ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row no-margin">
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php
                                        echo $this->Form->input('municipality', array('type' => 'text', 'class' => 'form-control', 'role' => 'address', 'label' => __('municipality')))
                                        ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row no-margin">
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php
                                        echo $this->Form->input('municipal_town', array('type' => 'text', 'class' => 'form-control', 'role' => 'address', 'label' => __('municipal town')))
                                        ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="row no-margin">
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('bank_name', array('type' => 'text', 'class' => 'form-control', 'label' => __('bank name'), 'placeholder' => __('bank name'), 'role' => 'name')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('branch_name', array('type' => 'text', 'class' => 'form-control', 'label' => __('branch name'), 'placeholder' => __('branch name'), 'role' => 'name')) ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row no-margin">
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('account_number', array('type' => 'text', 'class' => 'form-control', 'label' => __('account number'), 'placeholder' => __('account number'), 'role' => 'name')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('account_name', array('type' => 'text', 'class' => 'form-control', 'label' => __('account name'), 'placeholder' => __('account name'), 'role' => 'name')) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="row no-margin">
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('basic_salary', array('type' => 'text', 'class' => 'form-control', 'label' => __('basic salary'), 'placeholder' => __('basic salary'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('daily_wage', array('type' => 'text', 'class' => 'form-control', 'label' => __('lương ngày'), 'placeholder' => __('lương ngày'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('hourly_wage', array('type' => 'text', 'class' => 'form-control', 'label' => __('lương giờ'), 'placeholder' => __('lương giờ'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row no-margin">
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('social_insurance', array('type' => 'text', 'class' => 'form-control', 'label' => __('social insurance'), 'placeholder' => __('social insurance'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('employment_insurance', array('type' => 'text', 'class' => 'form-control', 'label' => __('employment insurance'), 'placeholder' => __('employment insurance'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('basis_pension_number', array('type' => 'text', 'class' => 'form-control', 'label' => __('basic pension number'), 'placeholder' => __('basic pension number'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="row no-margin">
                                ...
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('public_transportation', array('type' => 'text', 'class' => 'form-control', 'label' => __('public transportation (regular monthly fee)'), 'placeholder' => __('public transportation'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('vehicle_cost', array('type' => 'text', 'class' => 'form-control', 'label' => __('vehicle cost (amount per attendance)'), 'placeholder' => __('vehicle cost'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('one_way_transportation', array('type' => 'text', 'class' => 'form-control', 'label' => __('one way transportation'), 'placeholder' => __('one way transportation'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('round_trip_transportation', array('type' => 'text', 'class' => 'form-control', 'label' => __('round trip transportation'), 'placeholder' => __('round trip transportation'), 'role' => 'money', 'onkeydown' => 'numberInput(event)')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <label for="EmployeeCommuteRoute"><?php echo __('commute route') ?></label>
                                        <?php echo $this->Form->textarea('commute_route', array('type' => 'text', 'class' => 'form-control', 'placeholder' => __('commute route'), 'role' => 'address')) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="row no-margin">
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('sos_contact_person', array('type' => 'text', 'class' => 'form-control', 'label' => __('tên người liên lạc lúc cần'), 'placeholder' => __('tên người liên lạc lúc cần'), 'role' => 'name')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('sos_contact_person_kana', array('type' => 'text', 'class' => 'form-control', 'label' => __('tên Kana của người liên lạc lúc cần'), 'placeholder' => __('tên Kana của người liên lạc lúc cần'), 'role' => 'name')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('sos_phone', array('type' => 'text', 'class' => 'form-control input-phone', 'label' => __('sos phone'), 'placeholder' => __('sos phone'), 'role' => 'phone')) ?>
                                    </div>
                                </div>
                                <div class="col-sm-12 no-padding">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('sos_address', array('type' => 'text', 'class' => 'form-control', 'label' => __('địa chỉ liên lạc lúc cần'), 'placeholder' => __('địa chỉ liên lạc lúc cần'), 'role' => 'address')) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row row-5" role="container">
            <div class="col-sm-12">
                <div class="box">
                    <div class="box-body">
                        <div class="form-group">
                            <?php echo $this->Form->input('employee_register_only', array('type' => 'checkbox', 'class' => 'form-control', 'label' => __('Employee registration authority only'))); ?>
                        </div>
                        <div class="form-group">
                            <?php echo $this->Form->input('have_sale_permission', array('type' => 'checkbox', 'class' => 'form-control', 'label' => __('sales registration right'))); ?>
                        </div>
                        <br>
                        <p>シフト権限 （１つ選択）</p>
                        <div class="form-group group-radio">
                            ...
                            echo $this->Form->radio("shift_authority", $radio_options, array('legend'=>false,'class' => 'radio-option', 'default' => 'shift_authority_view'));
                            ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box-body">
                        <div class="row no-margin">
                            <div class="form-group">
                                ...
                                <?php
                                echo $this->Form->textarea('profile', array('class' => 'form-control', 'role' => 'profile'));
                                ?>
                            </div>
                        </div>
