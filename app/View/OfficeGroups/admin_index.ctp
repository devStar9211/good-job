        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <?php foreach ($collection as $_data) { ?>
                    <div class="form-group row">
                        ...
                        <div class="col-md-2  col-sm-2 col-xs-2">
                            <?php
                            echo $this->Form->input('FormData.' . $config_field['fields']['position'] . '.' .
                                $_data[$config_field['model']]['id'], array('type' => 'text', 'label' => false, 'style' => 'width: 100%; ', 'value' => $_data[$config_field['model']]['position'], 'class' => 'form-control ', 'maxlength' => '100', 'placeholder' => __('Display order')));
                            ?>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                        <?php
                        echo $this->Form->input('EditData.position', array('label' => false, 'style' => 'width: 100%; ', 'value' => '', 'class' => 'form-control', 'placeholder' => __('Display order')));
                        ?>
                    </div>
                    <div class="col-md-6  col-sm-6 col-xs-6">
                        <div class="row" style="width: 250px;">
