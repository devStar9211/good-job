...
<?php echo $this->Form->create('GroupPermission'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Group Permission'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GroupPermission.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('GroupPermission.id'))); ?></li>
