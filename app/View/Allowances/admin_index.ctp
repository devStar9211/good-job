    ...
    <div class="row">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                ?>
                <?php
                $options = array(0 => '', 1 => __('Month fixed'), 2 => __('Number of Attendance'));
                foreach ($collection as $_data) { ?>
                    <div class="form-group row">
                        <div class="cat_col_name col-md-4  col-sm-4 col-xs-4">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            <?php
                            echo $this->Form->input('FormData.' . $config_field['fields']['price'] . '.' .
                                $_data[$config_field['model']]['id'], array('type' => 'text', 'label' => false, 'style' => 'width: 100%; ', 'value' => $_data[$config_field['model']]['price'], 'class' => 'form-control ', 'maxlength' => '100'));
                            ?>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-2">
                            <?php

                            echo $this->Form->input('FormData.' . $config_field['fields']['option'] . '.' .
                                $_data[$config_field['model']]['id'], array('type' => 'select', 'label' => false, 'style' => 'width: 100%; ', 'options' => $options, 'default' => $_data[$config_field['model']]['option'], 'class' => 'form-control ', 'maxlength' => '100'));
                            ?>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                        <?php
                        echo $this->Form->input('EditData.price', array('label' => false, 'style' => 'width: 100%; ', 'value' => '', 'class' => 'form-control', 'placeholder' => __('Price')));
                        ?>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2">
                        <?php
                        echo $this->Form->input('EditData.option', array('type' => 'select', 'label' => false, 'style' => 'width: 100%; ', 'options' => $options, 'class' => 'form-control', 'placeholder' => __('Price')));
                        ?>
                    </div>
